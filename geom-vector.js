...
s+='<button id="appBtn" onclick="winNew()" style="z-index:2;" class="btn">'
s+= '<svg xmlns="http://www.w3.org/2000/svg" width="26" height="21" '
s+= 'version="1.1" style="stroke-width:2; fill:none; vertical-align:middle;">'
s+= '<rect style="stroke:grey;" x="1" y="6" ry="4" width="19" height="13"></rect>'
s+= '<path style="stroke:#cdf;stroke-width:3;" d="m 14,6 h 6 v 6"></path>'
s+= '<path style="stroke:black;" d="m 16,2 h 8 v 8"></path>'
s+= '<path style="stroke:black;" d="m 14,12 10,-10"></path>'
s+= '</svg>'
s+='</button>'
s+='</div>'
...
s+='</div>'
s+='<div><strong>Recreated by Luc1f3r</strong></div>'
